...
class STSGCN(nn.Module):
    def __init__(self, configs, adj):
        ...
        first_layer_embedding_size = configs['first_layer_embedding_size']
        out_layer_dim = configs['out_layer_dim']
        activation = configs['activation']
        use_mask = configs['use_mask']
        temporal_emb = configs['temporal_emb']
        spatial_emb = configs['spatial_emb']
